...
import { inspectionModeMiddleware } from "./inspection-mode";
...
async function startServer() {
  ...
  // Inspection mode middleware - allows temporary read-only public access
  app.use(inspectionModeMiddleware);
  ...
  // AI Inspection router - read-only semantic inspection for browser-blind AI
  // MUST be mounted BEFORE setupVite/serveStatic to bypass the SPA catch-all
