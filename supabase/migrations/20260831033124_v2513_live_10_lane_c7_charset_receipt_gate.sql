-- ============================================================================
-- Migration: lane c7 -- C7 decoding receipts and middle-initial period protection
...
begin
  ...
  for v_index in 2..char_length(p_value) - 1 loop
    if substr(p_value, v_index, 1) = '.' and (
         rosetta_v2513.c7_rosetta_v25_is_internal_period(p_value, v_index)
         or (
...
begin
  ...
  perform rosetta_v2513.c7_rosetta_v25_charset_gate(
...
$function$;
CREATE OR REPLACE FUNCTION rosetta_v2513.c7_rosetta_v25_charset_gate(p_source_document_id integer, p_source_content_id uuid, p_source_text text)
 RETURNS void
 LANGUAGE plpgsql
 STABLE
 SET search_path TO 'pg_catalog', 'public', 'extensions'
