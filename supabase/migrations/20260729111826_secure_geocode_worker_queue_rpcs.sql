create or replace function public.claim_geocode_queue_batch_secure(
  p_candidate text,
...
create or replace function public.finalize_geocode_queue_item_secure(
  p_candidate text,
  p_id integer,
  p_queue_status text,
...
revoke all on function public.finalize_geocode_queue_item_secure(text, integer, text, double precision, double precision, text) from public;
...
grant execute on function public.finalize_geocode_queue_item_secure(text, integer, text, double precision, double precision, text) to anon, authenticated, service_role;
