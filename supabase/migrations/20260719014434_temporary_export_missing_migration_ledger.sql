create or replace function public.export_missing_migration_ledger_reconciliation()
...
revoke all on function public.export_missing_migration_ledger_reconciliation() from public, authenticated, service_role;
grant execute on function public.export_missing_migration_ledger_reconciliation() to anon;
