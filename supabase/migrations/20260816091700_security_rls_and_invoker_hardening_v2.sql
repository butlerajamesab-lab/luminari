...
ALTER VIEW public.v_lighthouse_filing_catalog_v1 SET (security_invoker = true);
ALTER VIEW public.v_lighthouse_signal_catalog_v1 SET (security_invoker = true);
ALTER VIEW public.v_lighthouse_legal_catalog_v1 SET (security_invoker = true);
ALTER VIEW public.v_lighthouse_case_surface_status_v1 SET (security_invoker = true);
ALTER VIEW public.v_luminari_resource_locations_current_v3_13 SET (security_invoker = true);
ALTER VIEW public.v_domain_deep_dive_v3_13_stage_summary SET (security_invoker = true);
ALTER VIEW public.v_registry_resources_unified SET (security_invoker = true);
ALTER VIEW public.v_corpus_artifact_coverage SET (security_invoker = true);
ALTER VIEW public.v_generated_sql_source_coverage SET (security_invoker = true);
ALTER VIEW public.v_generated_sql_bundle_audit SET (security_invoker = true);
ALTER VIEW public.v_substrate_promotion_readiness SET (security_invoker = true);
ALTER VIEW public.v_operational_core_namespace_status SET (security_invoker = true);
ALTER VIEW public.v_operational_core_governance_summary SET (security_invoker = true);
ALTER VIEW public.v_operational_core_legal_summary SET (security_invoker = true);
ALTER VIEW public.v_operational_core_bridge_summary SET (security_invoker = true);
ALTER VIEW public.registry_record_provenance SET (security_invoker = true);
