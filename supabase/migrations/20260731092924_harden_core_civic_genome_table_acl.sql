...
begin
  ...
  loop
    ...
    execute format('drop policy if exists %I on public.%I', 'auth_read_' || table_name, table_name);
    ...
    execute format('drop policy if exists %I on public.%I', 'service_all_' || table_name, table_name);
