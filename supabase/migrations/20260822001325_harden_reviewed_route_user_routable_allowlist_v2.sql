-- Centralize person-facing reviewed-route eligibility in one governed,
-- fail-closed database predicate. Unknown/future/free-form statuses remain
-- reference-only until explicitly admitted here.
