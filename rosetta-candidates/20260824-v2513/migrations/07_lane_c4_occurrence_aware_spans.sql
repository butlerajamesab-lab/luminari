-- ============================================================================
-- Migration: lane c4 -- C4 occurrence-aware span binding (ported 2.5.12 trio + refresh)
...
values ('rosetta-v3-deterministic-sql-2.5.13-c4', 'rosetta-five-layer-structural-correctness-2.5.13-c4',
        '18052d1c47d6a503c7dedd15dc220d32fee70f5ca7667450973c8e31970af53e', $manifest${"changes":["C4 occurrence-aware span binding (ported 2.5.12 trio + refresh)"],"closure_namespace":"rosetta_v2513","closure_prefix":"c4_","control_identity":"rosetta-v3-deterministic-sql-2.5.11","engine_version":"rosetta-v3-deterministic-sql-2.5.13-c4","lane":"c4","publication":"structurally disabled: no publication view, no registry row, no publishable-run path references this namespace","rule_set_version":"rosetta-five-layer-structural-correctness-2.5.13-c4","title":"C4 occurrence-aware span binding (ported 2.5.12 trio + refresh)"}$manifest$::jsonb, true);