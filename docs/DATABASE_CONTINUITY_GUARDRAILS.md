...
This file is maintained in the active Lighthouse/Luminari V1 repository. It is a Lighthouse-facing recovery guardrail for this Render deployment repo and its relationship to the other substrates. It should not be read as a complete implementation plan for Prism, Atlas, Rosetta, or Esquire; those repositories need their own substrate-specific recovery files.
