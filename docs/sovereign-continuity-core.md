...
4. Schema inspection accepts only validated public-schema identifiers.
...
This document records the boundary; focused CI enforces the executable portions of it.
