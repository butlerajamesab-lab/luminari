...
export const enginesV4Router = router({
  ...
  createSubscription: protectedProcedure
    ...
    .mutation(({ ctx, input }) => withEngineTracking({ engineId: ENGINE_IDS.PUBLIC_ALERTING, caseId: 0 }, () => createSubscription({
  ...
  toggleSubscription: protectedProcedure
    ...
    .mutation(({ input }) => withEngineTracking({ engineId: ENGINE_IDS.PUBLIC_ALERTING, caseId: 0 }, () => toggleSubscription(input.subscriptionId, input.isActive))),

  deleteSubscription: protectedProcedure
    .input(z.object({ subscriptionId: z.number() }))
    .mutation(({ input }) => withEngineTracking({ engineId: ENGINE_IDS.PUBLIC_ALERTING, caseId: 0 }, () => deleteSubscription(input.subscriptionId))),

  checkAlerts: protectedProcedure
    .mutation(() => withEngineTracking({ engineId: ENGINE_IDS.PUBLIC_ALERTING, caseId: 0 }, () => checkAlertTriggers())),

  processDeliveries: protectedProcedure
    .mutation(() => withEngineTracking({ engineId: ENGINE_IDS.PUBLIC_ALERTING, caseId: 0 }, () => processEventsToDelivery())),
  ...
  markNotificationRead: protectedProcedure
    ...
    .mutation(({ input }) => withEngineTracking({ engineId: ENGINE_IDS.PUBLIC_ALERTING, caseId: 0 }, () => markNotificationRead(input.eventId))),
  ...
  upsertNode: protectedProcedure
    ...
    .mutation(({ input }) => withEngineTracking({ engineId: ENGINE_IDS.SYSTEMIC_MAP, caseId: 0 }, () => upsertMapNode(input))),
  ...
  createEdge: protectedProcedure
    ...
    .mutation(({ input }) => withEngineTracking({ engineId: ENGINE_IDS.SYSTEMIC_MAP, caseId: 0 }, () => createMapEdge(input))),

  buildMap: protectedProcedure
    .mutation(() => withEngineTracking({ engineId: ENGINE_IDS.SYSTEMIC_MAP, caseId: 0 }, () => buildMapFromSignals())),
  ...
  addAnnotation: protectedProcedure
    ...
    .mutation(({ ctx, input }) => withEngineTracking({ engineId: ENGINE_IDS.SYSTEMIC_MAP, caseId: 0 }, () => addAnnotation({
      nodeId: input.nodeId,
  ...
  upsertFailureProfile: protectedProcedure
    ...
    .mutation(({ input }) => withEngineTracking({ engineId: ENGINE_IDS.FAILURE_PREDICTION, caseId: 0 }, () => upsertFailureProfile(input))),
  ...
  recordTimelineEvent: protectedProcedure
    ...
    .mutation(({ input }) => withEngineTracking({ engineId: ENGINE_IDS.FAILURE_PREDICTION, caseId: 0 }, () => recordTimelineEvent(input))),
