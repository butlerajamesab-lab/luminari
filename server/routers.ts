...
export const appRouter = router({
  benefitsDshsOfficeProof: publicProcedure.query(async () => read_benefits_resource_proof("benefits_office", "benefitsDshsOfficeProof")),
  civicMapDshsOfficeProof: publicProcedure.query(async () => read_benefits_resource_proof("benefits_office", "civicMapDshsOfficeProof")),
  civicMapResourceProof: publicProcedure.query(async () => read_benefits_resource_proof("food_bank", "civicMapResourceProof")),
  benefitsResourceDirectoryProof: publicProcedure.query(async () => read_benefits_resource_proof("food_bank", "benefitsResourceDirectoryProof")),
  auth: authRouter,
  system: systemRouter,
