...
export const SPINE_CONFIG_TABLES = [
  ...
  "sys_strategy_paths", "procedural_timelines", "procedural_outputs",
  ...
  "escalation_thresholds", "escalation_routes", "enforcement_viability_rules",
  ...
  "harm_map_nodes", "harm_map_edges", "outcome_registry", "outcome_metrics",
  "populations_affected", "litigation_registry", "litigation_barriers",
