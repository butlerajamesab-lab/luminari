...
function nextStatus(rawText, error) {
...
async function readDocxRows(pool, columns, targetId = null) {
  ...
  const wanted = [
    ...
    "base64_payload", "payload", "record_count_estimate", "storage_mode", "import_status", "created_at",
...
async function main() {
  ...
  const report = {
    ...
    parser: {
      ...
      dependencyAttempt: "mammoth preferred, but this implementation intentionally uses a controlled WordprocessingML XML fallback without adding dependencies.",
    },
    safety: {
