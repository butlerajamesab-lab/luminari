...
export type AtlasBridgeDrainResult = Record<string, unknown>;
...
export function triggerAtlasBridgeDrain(): Promise<AtlasBridgeDrainResult> {
  return atlasFetch<AtlasBridgeDrainResult>("/scheduler/bridge-drain", {
    method: "POST",
  });
}
