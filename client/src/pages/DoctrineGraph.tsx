...
export default function DoctrineGraph() {
  ...
  return (
    <div style={{ background: c.bg, minHeight: "100vh", padding: "20px clamp(12px,3vw,32px) 56px", fontFamily: fontSans }}>
      <LayerNavBar label="Legal & Doctrine Graph" route="/doctrine-graph" />

      <header style={{ marginBottom: 20 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <Network size={23} color={c.purple} />
          <h1 style={{ color: c.paper, fontFamily: fontSerif, fontSize: 28, margin: 0 }}>Legal & Doctrine Graph Explorer</h1>
        </div>
        <p style={{ color: c.muted, maxWidth: 850, fontSize: 13, lineHeight: 1.6, margin: "8px 0 0" }}>
          The full current civic/legal universe is discoverable here. Doctrine is one node type, not the boundary of the graph. The working diagram renders a bounded neighborhood for performance; the totals and filters describe the complete current universe and the governed reference libraries remain preserved below.
        </p>
      </header>
