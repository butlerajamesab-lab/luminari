...
function AuthenticatedDocumentDetail() {
  ...
  return (
    <div className="space-y-6">
      ...
      <ReplaceDocumentModalV2 open={resolutionModal?.type === 'uploadReplace'} onClose={() => setResolutionModal(null)} documentId={docId} caseId={doc.caseId} documentName={doc.filename} initialMode="upload" onSuccess={() => { utils.documents.get.invalidate(); utils.documents.list.invalidate(); utils.analyze.getIntakeIntegrityProjection.invalidate(); }} />
    </div>
  );
}
