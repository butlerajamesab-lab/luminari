...
function get_duwamish_layer_fields(active_layer_slug: layer_slug): { fields: preview_field[]; conflict_fields: ReturnType<typeof get_conflict_fields> } {
  ...
  const layer_fields: Record<layer_slug, preview_field[]> = {
    ...
    language: [
      ...
      { label: "language_program_name", value: duwamish_truth_seed.layer_5_living_culture.language.program_name, source_url: duwamish_truth_seed.layer_5_living_culture.language.source.url, source_posture },
      { label: "language_program_purpose", value: duwamish_truth_seed.layer_5_living_culture.language.program_purpose, source_url: duwamish_truth_seed.layer_5_living_culture.language.source.url, source_posture },
      { label: "living_practices", value: duwamish_truth_seed.layer_5_living_culture.living_practices.map((practice) => practice.practice_name), source_url: duwamish_truth_seed.layer_5_living_culture.source.url, source_posture },
      { label: "living_practice_significance", value: duwamish_truth_seed.layer_5_living_culture.living_practices.map((practice) => practice.cultural_significance), source_url: duwamish_truth_seed.layer_5_living_culture.source.url, source_posture },
      { label: "physical_home_name", value: duwamish_truth_seed.layer_5_living_culture.physical_home.name, source_url: duwamish_truth_seed.layer_5_living_culture.physical_home.source.url, source_posture },
      { label: "physical_home_historical_note", value: duwamish_truth_seed.layer_5_living_culture.physical_home.historical_note, source_url: duwamish_truth_seed.layer_5_living_culture.physical_home.source.url, source_posture },
      { label: "physical_home_hours", value: duwamish_truth_seed.layer_5_living_culture.physical_home.hours, source_url: duwamish_truth_seed.layer_5_living_culture.physical_home.source.url, source_posture },
      { label: "physical_home_functions", value: duwamish_truth_seed.layer_5_living_culture.physical_home.functions, source_url: duwamish_truth_seed.layer_5_living_culture.physical_home.source.url, source_posture },
      { label: "environmental_coalition", value: duwamish_truth_seed.layer_5_living_culture.environmental_coalition, source_url: duwamish_truth_seed.layer_5_living_culture.source.url, source_posture },
    ],
    "ally-call": [
